...
<x-app-layout>
    <div class="max-w-2xl mx-auto py-8 px-4">
        ...
        <a href="{{ route('kepala-bps.approval.index') }}" class="inline-flex items-center gap-1.5 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 text-sm font-medium px-4 py-2 rounded-lg transition-colors">
