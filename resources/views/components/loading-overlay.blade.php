...
{{--
    x-teleport="body" penting: memindahkan overlay ini ke akhir <body> saat
    dirender, supaya posisinya SELALU relatif ke viewport (benar-benar full
    layar), berapa pun dalamnya component ini disisipkan di dalam elemen
    lain — termasuk elemen yang punya x-transition/transform, yang secara
    CSS bisa "menjebak" position:fixed jadi cuma sebesar parent-nya.
--}}
