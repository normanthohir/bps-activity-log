    ...
    <div class="max-w-xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden" x-data="{
            ...
            <form method="POST" action="{{ route('kepala-bps.tugas.store') }}" class="p-6" x-ref="form" novalidate>
                ...
                <div class="mb-5">
                    <label class="text-sm font-medium text-gray-700 block mb-1.5">Pilih Bagian <span
                ...
                <div class="mb-5">
                    <label class="text-sm font-medium text-gray-700 block mb-1.5">Ditugaskan Ke <span
                            class="text-red-500">*</span></label>
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="tenggat" x-model="tenggat" min="{{ now()->toDateString() }}"
                        class="w-full rounded-lg text-sm focus:ring-[#1F3864]/20 focus:border-[#1F3864]"
                ...
                <x-loading-overlay message="Mengirim tugas..." />
                ...
                <div class="flex justify-end gap-2 pt-5 border-t border-gray-100">
                    ...
                    <x-submit-button type="button" onclick="submit()" loadingText="Mengirim tugas...">
                        Berikan Tugas
                    </x-submit-button>
                </div>
            </form>
