    ...
    <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div
            ...
            <div class="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p class="text-white/70 text-sm mt-1">Kepala Seksi &middot; {{ $bagian->nama_bagian }} &middot;
                        {{ $staf->count() }} staf</p>
                </div>
                <x-action-button href="{{ route('kabag.tugas.create') }}" variant="light">
                    Beri Tugas
                </x-action-button>
                    ...
                    @if ($totalTugasTim > 0)
                        ...
                        <div class="flex flex-wrap gap-x-5 gap-y-1.5 mt-3 text-xs text-gray-600">
                            <span class="flex items-center gap-1.5"><span
                                    class="w-2 h-2 rounded-full bg-green-500"></span> Selesai
                                ({{ $tugasTimSelesai }})</span>
                            <span class="flex items-center gap-1.5"><span
                                    class="w-2 h-2 rounded-full bg-blue-500"></span> Dikerjakan
                                ({{ $tugasTimDikerjakan }})</span>
                            <span class="flex items-center gap-1.5"><span
                                    class="w-2 h-2 rounded-full bg-gray-300"></span> Belum Dikerjakan
                                ({{ $tugasTimBelum }})</span>
                        </div>
                    @else
                ...
                <div class="animate-in delay-3 bg-white border border-gray-200 rounded-xl overflow-hidden">
                    <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                        ...
                        <a href="{{ route('kabag.tugas.index') }}"
                            class="text-xs font-medium text-[#1F3864] hover:underline">Lihat semua</a>
                    </div>
                        ...
                        <div class="divide-y divide-gray-100">
                            @foreach ($tugasTimTerbaru as $tugas)
                                ...
                                <a href="{{ route('kabag.tugas.show', $tugas) }}"
                                    ...
                                    <div class="min-w-0">
                                        <p
                                            class="font-medium text-gray-900 text-sm truncate group-hover:text-[#1F3864] transition-colors">
                                            {{ $tugas->judul }}</p>
                                    ...
                                    <span
                                        class="inline-flex items-center gap-1.5 {{ $badge[0] }} text-xs font-medium px-2.5 py-1 rounded-full ring-1 ring-inset shrink-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            <a href="{{ route('kabag.tugas.index') }}"
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 rounded-lg bg-[#DCE6F1] flex items-center justify-center group-hover:bg-[#1F3864] transition-colors">
                        <svg class="w-5 h-5 text-[#1F3864] group-hover:text-white transition-colors" fill="none"
